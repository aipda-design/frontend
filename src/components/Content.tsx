...
import { CountryData, ITitle } from "../service/Interface";
...
const Content = () => {
	...
	return (
		<>
			...
			>
				<div className="rounded-2xl lg:rounded-[28px] m-2 md:m-4 h-[calc(100vh - 16px)] lg:h-[calc(100vh-36px)]  w-full overflow-hidden">
					<div
