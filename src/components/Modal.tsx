...
import { paysAfrique } from "../utils/table";
import { paysEurope } from "../utils/table";
...
export const Modal: React.FC<IModalProps> = ({
	...
	return (
		<>
			{showModal ? (
				<>
					<div className="justify-center items-center flex overflow-x-hidden px-2 overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        ...
                        `}
								...
								{/*footer*/}
								<div className={`flex items-center justify-end p-6 border-t border-solid border-${bouttonColor} rounded-b`}>
									<button
