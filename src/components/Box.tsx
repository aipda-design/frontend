...
export default function Box({
    ...
    return (
        <>
            {/*avant au niveau du Link className={` flex flex-col items-start  xs:w-min md:max-w-min min-h-[180px]  p-3 rounded-2xl bg-${bgColor} ${
                        link === "as" || link === "am"
            ...
            <div className={` ${link === "af" || link === "eu" ? "box" : null}`}>
                <Link
                    ...
                    className={` flex flex-col items-start xs:w-min md:max-w-min min-h-[180px]  p-3 rounded-2xl bg-${bgColor} ${
                        link === "as" || link === "am"
                            ? `hidden md:block md:pointer-events-none opacity-30 md:bg-[#010928] mix-blend-normal`
                            : null
                    }`}
